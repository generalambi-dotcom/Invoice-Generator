    ...
    try {
        ...
        const defaultTemplates = [
            // Auth
            {
                ...
                category: 'auth',
                subject: 'Verify your email address — Invoice Generator',
            ...
            },
            {
                ...
                body: '<p>Hi {{userName}},</p><p>Welcome to Invoice Generator! Your account is now set up and ready to go.</p><p>Here are some things you can do right away:</p><ul><li>Create your first invoice</li><li>Add your company details</li><li>Set up payment methods</li></ul><p>If you have any questions, feel free to reach out to our support team.</p><p>Happy invoicing!<br/>The Invoice Generator Team</p>',
