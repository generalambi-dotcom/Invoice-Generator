...
import { RecurringInvoice } from '@prisma/client'; // Check if we can import this type or define locally
...
export default function RecurringInvoicesPage() {
    ...
    // This would ideally come from a shared state or layout context
    ...
    return (
        <div className="flex h-screen bg-gray-50">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                <Header onMenuClick={() => setIsSidebarOpen(true)} title="Recurring Invoices" />
