        ...
        <div className="bg-white py-8 px-6 shadow rounded-lg sm:px-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
              >
