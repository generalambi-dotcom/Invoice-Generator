    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
                <h2 className="text-xl font-semibold text-gray-900">Subscription Pricing</h2>
                <p className="text-sm text-gray-500 mt-1">
                    Manage subscription costs for different regions.
                </p>
            </div>
            ...
            <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="p-6 bg-blue-50 rounded-lg border border-blue-200">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">Nigeria Pricing</h3>
                    ...
                    <div className="p-6 bg-green-50 rounded-lg border border-green-200">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">Rest of World Pricing</h3>
                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                    Premium Price (USD)
